...
class TweetFetcher extends TransientFetcher
{
    ...
    private function twitterify($content = '')
    {
        ...
        $content = preg_replace("#(^|[\n ])([\w]+?://[\w]+[^ \"\n\r\t< ]*)#", "\\1<a href=\"\\2\" target=\"_blank\" rel=\"noopener\">\\2</a>", $content);
        $content = preg_replace("#(^|[\n ])((www|ftp)\.[^ \"\t\n\r< ]*)#", "\\1<a href=\"http://\\2\" target=\"_blank\" rel=\"noopener\">\\2</a>", $content);
        $content = preg_replace("/^@(\w+)/", "<a href=\"http://www.twitter.com/\\1\" target=\"_blank\" rel=\"noopener\">@\\1</a>", $content);
        $content = preg_replace("/#(\w+)/", "<a href=\"http://twitter.com/search?q=\\1\" target=\"_blank\" rel=\"noopener\">#\\1</a>", $content);
